...
const defaultStyles: any = getDefaultStyles();

interface IRichTextBoxState {
    selectedTag: string
    ...
    hasCameraRollPermission: any
}
interface IRichTextBoxProps { }

class RichTextBox extends Component<IRichTextBoxProps, IRichTextBoxState> {
    customStyles: any = {}
    editor: any = ""
    constructor(props) {
        super(props);
    ...
    onRemoveImage = (url: string, id: string) => {
    ...
    render() {
        ...
        // console.log(convertToObject('<div><p><span>This is </span><span style="font-weight: bold;">bold</span><span> and </span><span style="font-style: italic;">italic </span><span>text</span></p></div>'), "Object")
                                    ...
                                    iconArray: [
                                        {
                                            ...
                                            iconComponent:
                                                <TouchableOpacity onPress={() => { console.log("Save") }}>
                                                    <MaterialCommunityIcons size={25} name="content-save" />
                                                </TouchableOpacity>
                                        }
                                    ]
                                },
